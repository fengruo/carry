...
public class check_servlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		PrintWriter out = response.getWriter();
		 ...
		 String check_userid=request.getParameter("check_userid");;
		...
		System.out.println(pageid+"111111111111111"+check_userid);
		response.sendRedirect("content.action?id="+Integer.parseInt(pageid));
